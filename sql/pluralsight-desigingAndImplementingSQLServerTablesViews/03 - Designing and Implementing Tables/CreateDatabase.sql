...
--       C:\Projects\pluralsight\sql\pluralsight-desigingAndIMplementingSQLServerTablesViews\03 - Designing and Implementing Tables\
...
ALTER DATABASE BobsShoes
    ADD FILE (
       NAME = BobsData,
       FILENAME = 'C:\Projects\pluralsight\sql\pluralsight-desigingAndIMplementingSQLServerTablesViews\03 - Designing and Implementing Tables\BobsData.mdf'
    )
...
ALTER DATABASE BobsShoes
    ADD LOG FILE ( 
        NAME = BobsLogs,
        FILENAME = 'C:\Projects\pluralsight\sql\pluralsight-desigingAndIMplementingSQLServerTablesViews\03 - Designing and Implementing Tables\BobsLog.ldf'
    );
