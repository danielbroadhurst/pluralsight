...
describe("File Management", () => {
  ...
  it("Should throw an excection if file already exists", () => {
    const writeStub = sinon.stub(fs, "writeFileSync");
  ...
  it("getAllFiles should reutrn a list of files", function () {
  ...
  it("getAllFilesPromise should reutrn a list of files", function () {
    const readStub = sinon.stub(fs, "readdir");
