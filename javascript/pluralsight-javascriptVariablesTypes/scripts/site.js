...
function generateRickProfile(la) {
  ...
  var summaryText = highlightText`Dear ${la.ApplicantName},</br> ${reviewText}</br> Your risk profile is ${riskProfile},</br> Your Code is ${applicationCode}`;
...
function createApplicationId() {
  var result = "";
  var characters = "ABCDEFGHIJJKLMNOPQRSTUVWXYZ0123456789abcdefh";
