var _ = require('./externalFiles/ramda.min.js');
...
var names = _.map(_.compose(get('name'),get('author'))); // change this
...
var isAuthor = function (string, articles) {
  return _.compose(_.contains(string), names)(articles)
}; // change this
